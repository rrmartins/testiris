...
func demoBase64(message string) {
  ...
  fmt.Println("encoding base64 msg:")
...
func demoJson() {
  ...
  var newEmp Employee
  str := `{"Id": "123456", "Name": "Brown", "Email": "brown@email.com"}`
...
func demoXml() {
  ...
  type EmployeeCountry struct {
    ...
    CountryName string `xml:",chardata"` // XML attribute: code
  }
...
func demoCsv() {
  ...
  // reado csv file to a array of struct
